...
namespace TelerikMvcApp1.Controllers
{
    ...
    {  // GET: Guest
        [HttpGet]
        public ActionResult Normal_News_Read()
        {
            return View();
        }
        [HttpGet]
        public ActionResult Normal_News_Register()
        {
            return View();
        }
        [HttpGet]
        public ActionResult Normal_Booking_Read()
        {
            return View();
        }
        [HttpGet]
        public ActionResult Normal_Concert_Register()
        {
            return View();
        }
        [HttpGet]
        public ActionResult Normal_Reservation_Read()
        {
            return View();
        }
        [HttpGet]
        public ActionResult Normal_Booking_Reservation_Read()
        {
            return View();
        }
        /// <summary>
        ...
        #region News
        [HttpPost]
        public ActionResult Normal_News_Read([DataSourceRequest] DataSourceRequest request)
        {
        ...
        public ActionResult Normal_News_Register(NewsModels news)
        {
            ...
            if (news != null)
            {
                ...
                return RedirectToAction("Normal_News_Read");
            }
        ...
        #region Booking
        public ActionResult Normal_Booking_Reservation(Concert conc)
        {
            if (conc.Concert_Num == 0)
            {
                ...
                return View("Normal_Booking_Reservation", ds);
            }
            return View();
        }
        ...
        [HttpPost]
        public ActionResult Normal_Booking_Concert_Register(Concert conc)
        {
            if (conc == null)
            {
                return View();
        ...
        [HttpPost]
        public ActionResult Normal_Booking_Read([DataSourceRequest] DataSourceRequest request)
        {
            DataSet ds = new DataSet();
        ...
        [HttpPost]
        public ActionResult Normal_Booking_Reservation_Read([DataSourceRequest] DataSourceRequest request)
        {
            DataSet ds = new DataSet();
